...
דוח שנפתח וטרם נרשמה בו הערה מסומן **"טרם נרשמו הערות"** ולא "מוכן לסגירה",
ופס ההתקדמות שלו על 0 - כדי שדוח שלא נסקר לא ייראה כמו דוח שהסתיים. סגירה
שלו עדיין אפשרית (דוח בלי ממצאים הוא מקרה לגיטימי), עם הערה גלויה ליד הכפתור.
